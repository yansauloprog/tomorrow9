    ...
    <section id="top" className="hero-section">
      <div className="hero-copy reveal-up">
        ...
        <div className="hero-actions">
          <Button asChild className="bg-primary text-primary-foreground hover:bg-foreground">
    ...
    <section className="menu-callout">
      ...
      <div className="menu-callout-grid">
        ...
        <div>
          ...
          <Button asChild className="menu-button bg-background text-primary hover:bg-foreground hover:text-background">
