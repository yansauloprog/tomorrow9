...
const translations: Record<string, [string, string]> = {
  ...
  "Morning colour, served in a bowl.": ["Cor e frescura numa taça.", "Color y frescura en un bol."],
  "Breakfast plate with eggs, hash browns, bacon, salad and coffee": ["Prato de pequeno-almoço com ovos, batata crocante, bacon, salada e café", "Plato de desayuno con huevos, patata crujiente, bacon, ensalada y café"],
  "Salmon toast with tomato, cream cheese and fresh herbs": ["Tosta de salmão com tomate, queijo creme e ervas frescas", "Tostada de salmón con tomate, queso crema y hierbas frescas"],
  "Breakfast bowl with banana, fruit, coconut and nuts": ["Taça de pequeno-almoço com banana, fruta, coco e frutos secos", "Bol de desayuno con plátano, fruta, coco y frutos secos"],
  "Bowl of sliced meat, potatoes, tomatoes and greens": ["Taça com carne fatiada, batatas, tomate e verduras", "Bol con carne en lonchas, patatas, tomate y verduras"],
  "Shakshuka with bread and fresh herbs": ["Shakshuka com pão e ervas frescas", "Shakshuka con pan y hierbas frescas"],
  "Breakfast bowl with strawberries, raspberries, granola and coconut": ["Taça com morangos, framboesas, granola e coco", "Bol con fresas, frambuesas, granola y coco"],
  "Folded crepes with fruit and lime zest": ["Crepes dobrados com fruta e raspa de lima", "Crepes doblados con fruta y ralladura de lima"],
